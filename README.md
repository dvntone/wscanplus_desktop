...
- reports companion version details when the package is installed
- shows per-device next-step guidance for trusted-host authorization and companion readiness
